...
const Header = props => {
	...
	const moon = <IconButton aria-label="expand">
	<SvgIcon>
	...
	const [themeStyle,setThemeStyle] = useState({border:"2px solid green"})
	...
	return (
		...
		control={<Switch
			...
			name="changeTheme"
			style={themeStyle}
			inputProps={{ 'aria-label': 'change theme checkbox' ,role:'switch'}}
			/>}
			label="Choose theme"
